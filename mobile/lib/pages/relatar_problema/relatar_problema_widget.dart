...
class RelatarProblemaWidget extends StatefulWidget {
  const RelatarProblemaWidget({super.key});
...
class _RelatarProblemaWidgetState extends State<RelatarProblemaWidget> {
  late RelatarProblemaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RelatarProblemaModel());
                ...
                children: [
                  Column(
                    ...
                    children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Escreva o tipo do problema',
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          await RelatorioRecord.collection
                              .doc()
                              .set(createRelatorioRecordData(
                                tipo: _model.textController1.text,
